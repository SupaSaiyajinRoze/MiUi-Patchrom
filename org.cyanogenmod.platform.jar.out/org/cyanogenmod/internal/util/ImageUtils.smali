...
.method public static cropImage(Ljava/io/InputStream;IIII)Ljava/io/InputStream;
    ...
    :try_end_d2
    .catch Ljava/lang/Exception; {:try_start_74 .. :try_end_d2} :catch_d4
...
.method public static getCroppedKeyguardStream(Ljava/lang/String;Landroid/content/Context;)Ljava/io/InputStream;
    ...
    .catch Ljava/lang/Exception; {:try_start_27 .. :try_end_32} :catch_5e
    ...
    invoke-static {p0, p1}, Lorg/cyanogenmod/internal/util/ImageUtils;->getOriginalKeyguardStream(Ljava/lang/String;Landroid/content/Context;)Ljava/io/InputStream;
    :try_end_4b
    .catchall {:try_start_38 .. :try_end_4b} :catchall_7c
    .catch Ljava/lang/Exception; {:try_start_38 .. :try_end_4b} :catch_5e
    ...
    :try_end_59
    .catchall {:try_start_52 .. :try_end_59} :catchall_7c
    .catch Ljava/lang/Exception; {:try_start_52 .. :try_end_59} :catch_5e
...
.method private static getOriginalKeyguardStream(Ljava/lang/String;Landroid/content/Context;)Ljava/io/InputStream;
    ...
    :try_end_3a
    .catch Ljava/lang/Exception; {:try_start_c .. :try_end_3a} :catch_3c
...
.method private static getOriginalWallpaperStream(Ljava/lang/String;JLandroid/content/Context;)Ljava/io/InputStream;
    ...
    :try_end_63
    .catchall {:try_start_34 .. :try_end_63} :catchall_da
    .catch Ljava/lang/Exception; {:try_start_34 .. :try_end_63} :catch_9f
    ...
    :try_end_9e
    .catchall {:try_start_6a .. :try_end_9e} :catchall_da
    ...
    invoke-static {v4, v5}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_b9
    .catchall {:try_start_a0 .. :try_end_b9} :catchall_da
    ...
    :try_end_d8
    .catchall {:try_start_bd .. :try_end_d8} :catchall_da
    .catch Ljava/lang/Exception; {:try_start_bd .. :try_end_d8} :catch_9f
...
.method private static queryWpPathFromComponentId(Landroid/content/Context;Ljava/lang/String;J)Ljava/lang/String;
    ...
    :try_end_3b
    .catchall {:try_start_2b .. :try_end_3b} :catchall_4d
    .catch Ljava/lang/Exception; {:try_start_2b .. :try_end_3b} :catch_40
