...
.method private onReceiveForceSetRadioPowerIntent(Landroid/content/Intent;)V
    ...
    const-string v3, "force set radio power, mode: "
...
.method public notifyAirplaneModeChange(Z)V
    ...
    const-string v4, "persist.radio.airplane.mode.on"
...
.method public notifyMSimModeChange(I)V
    ...
    const-string v5, "MSIM mode changed, mode: "
...
.method public setRadioPower(ZI)V
    ...
    const-string v7, "Set Radio Power under airplane mode, ignore"
    ...
    const-string v7, "wifi-only device, so return"
    ...
    const-string v8, "modem for phone "
    ...
    const-string v8, " off, do not set radio again"
    ...
    const-string v7, "RILD initialize not completed, wait for 200ms"
    ...
    const-string v7, "setradiopower but wifi only, turn off"
    ...
    const-string v8, "No SIM inserted, force to turn on 3G/4G phone "
    ...
    const-string v8, " radio if no any sim radio is enabled!"
    ...
    const-string v8, "ECC call Radio Power, power: "
    ...
    :cond_9
    const-string v7, "No SIM inserted, turn Radio off!"
