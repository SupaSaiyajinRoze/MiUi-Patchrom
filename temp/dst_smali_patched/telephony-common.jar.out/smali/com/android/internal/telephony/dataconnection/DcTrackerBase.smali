...
.method protected setInitialAttachApn(Ljava/util/ArrayList;Lcom/android/internal/telephony/dataconnection/ApnSetting;)V
    ...
    const-string v2, "[IRAT_DcTracker] DO NOT setInitialApn for CDMA: numeric = "
    ...
    const-string v2, "[IRAT_DcTracker] GSM setInitialAttachApn: numeric = "
    ...
    :cond_2
    const-string v1, "[IRAT_DcTracker] GSM ignore IA because SIM not loaded."
    ...
    :cond_3
    const-string v1, "setInitialApn: but no operator numeric"
    ...
    const-string v1, "setInitialAttachApn: but no operator and no available apn"
    ...
    const-string v1, "setInitialAttachApn: but no operator"
