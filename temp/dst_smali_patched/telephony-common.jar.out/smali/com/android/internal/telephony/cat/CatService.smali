...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "Unrecognized CAT command: "
    ...
    :pswitch_6
    const-string v1, "MSG_ID_ICC_CHANGED"
    ...
    :pswitch_8
    const-string v1, "Received CAT CC Alpha message from card"
    ...
    const-string v2, "callCtrlInfo.length: "
    ...
    :cond_5
    :try_start_3
    const-string v1, "Null CC alpha id."
    ...
    const-string v1, "CC message drop"
    ...
    const-string v1, "IndexOutOfBoundsException adnStringFieldToString"
    ...
    :cond_6
    const-string v1, "CAT Alpha message: unexpected response type!"
    ...
    .end local v8    # "ar":Landroid/os/AsyncResult;
    :cond_8
    const-string v1, "CAT Alpha message: msg.obj is null"
    ...
    const-string v1, "SMS SEND TIMEOUT"
    ...
    const-string v1, "handleMsg : MSG_ID_SEND_SMS_RESULT"
    ...
    const-string v2, "The Msg ID data:"
    ...
    const-string v1, "SMS SEND GENERIC FAIL"
    ...
    :sswitch_1
    const-string v1, "SMS SEND FAIL - MEMORY NOT AVAILABLE"
    ...
    :sswitch_2
    const-string v1, "SMS SEND FAIL RETRY"
